...
namespace Filo{
    ...
    [CustomEditor(typeof(CableSection))] 
    public class CableSectionEditor : Editor
    {
        ...
        public override void OnInteractivePreviewGUI(Rect region, GUIStyle background)
        {
            ...
            for (int i = 0; i < section.Segments; i++){
                ...
                if (pos != olsPos){
                    ...
                    pos.x = Mathf.Clamp(CableSection.SnapTo(pos.x - region.center.x,section.snapX,5) / (region.width * 0.5f),-1,1);
                    pos.y = Mathf.Clamp(CableSection.SnapTo(pos.y - region.center.y,section.snapY,5) / (region.height * 0.5f),-1,1);
